...
class GraphState:
    ...
    accumulated_metrics: Dict[str, float] = field(default_factory=lambda: {"latencyMs": 0.0})
...
class Graph(MultiAgentBase):
    ...
    def _accumulate_metrics(self, node_result: NodeResult) -> None:
        ...
        self.state.accumulated_metrics["latencyMs"] += node_result.accumulated_metrics.get("latencyMs", 0.0)
