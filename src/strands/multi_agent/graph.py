...
class AgentGraph(MultiAgentBase):
    ...
    async def execute(self, task: str) -> List[MultiAgentResult]:
        ...
        logger.info("task=<%s> | starting graph execution", task)
        ...
        try:
            ...
            logger.info("status=<%s> | graph execution completed", self.state.status)
    ...
    async def resume_from_user_input(self, user_response: str) -> List[MultiAgentResult]:
        ...
        logger.info("user_response=<%s> | resuming graph execution with user input", user_response)
    ...
    async def _execute_node(self, node_id: str) -> None:
        ...
        logger.info("node_id=<%s> | executing node", node_id)
        ...
        try:
            ...
            if isinstance(node.executor, MultiAgentBase):
                ...
                multi_agent_result = MultiAgentResult(
                    ...
                    execution_time=0.0,  # TODO: track actual time if needed
                )
            ...
            logger.info("node_id=<%s> | node completed successfully", node_id)
